...
export function useTempleActivities() {
  ...
  const fetchEvents = async (entityId) => {
    try {
      ...
      const response = await axios.get(`v1/events`, createAuthHeader())
...
const fetchUpcomingEvents = async (entityId) => {
  ...
  const fetchSevas = async (entityId) => {
    try {
      ...
      const response = await axios.get(`/v1/sevas?entity_id=${entityId}`, createAuthHeader())
  ...
  const fetchMySevaBookings = async () => {
    try {
      ...
      const response = await axios.get(`/v1/sevas/my-bookings`, createAuthHeader())
