...
export const donationService = {
  ...
  async createDonation(donationData) {
    try {
      ...
      const url = `/v1/donations?entity_id=${entityId}`
  ...
  async getMyDonations() {
    try {
      ...
      const url = entityId ? `/v1/donations/my?entity_id=${entityId}` : '/v1/donations/my'
  ...
  async getMyRecentDonations() {
    try {
      ...
      const url = entityId ? `/v1/donations/recent?entity_id=${entityId}` : '/v1/donations/recent'
      const response = await axios.get(url, headers)
  ...
  async getDonationStats() {
    try {
      ...
      const url = entityId ? `/v1/donations/dashboard?entity_id=${entityId}` : '/v1/donations/dashboard'
      const response = await axios.get(url, headers)
  ...
  async getRecentDonations(limit = 5) {
    try {
      ...
      try {
        const url = entityId ? `/v1/donations/recent?entity_id=${entityId}&limit=${limit}` : `/v1/donations/recent?limit=${limit}`
      ...
      const fallbackUrl = entityId ? `/v1/donations?entity_id=${entityId}&limit=${limit}&page=1` : `/v1/donations?limit=${limit}&page=1`
  ...
  async getDonations(filters = {}) {
    try {
      ...
      const response = await axios.get('/v1/donations/', { params, ...headers })
  ...
  async generateReceipt(donationId) {
    try {
      ...
      const url = entityId ? `/v1/donations/${donationId}/receipt?entity_id=${entityId}` : `/v1/donations/${donationId}/receipt`
      const response = await axios.get(url, headers)
  ...
  async exportDonations(filters = {}, format = 'csv') {
    try {
      ...
      const response = await axios.get('/v1/donations/export', {
        params,
        ...headers,
        responseType: 'blob',
      })
