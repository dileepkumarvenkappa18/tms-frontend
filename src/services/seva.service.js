...
class SevaService {
  ...
  async getSevas(params = {}) {
    try {
      ...
      const url = entityId ? `/v1/sevas/entity-sevas?entity_id=${entityId}` : '/v1/sevas/entity-sevas';
  ...
  async getDevoteeSevas(params = {}) {
    try {
      ...
      const url = entityId ? `/v1/sevas?entity_id=${entityId}` : '/v1/sevas';
  ...
  async getBookingCounts() {
    try {
      ...
      const url = entityId ? `/v1/sevas/booking-counts?entity_id=${entityId}` : '/v1/sevas/booking-counts';
  ...
  async createSeva(sevaData) {
    try {
      ...
      const response = await axios.post('/v1/sevas', apiData, headers);
  ...
  async updateSeva(sevaId, sevaData) {
    try {
      ...
      const response = await axios.put(`/v1/sevas/${sevaId}`, apiData, headers);
  ...
  async deleteSeva(sevaId) {
    try {
      ...
      const response = await axios.delete(`/v1/sevas/${sevaId}`, {
        ...headers,
        params: { 
  ...
  async deactivateSeva(sevaId) {
    try {
      ...
      const response = await axios.patch(`/v1/sevas/${sevaId}/deactivate`, {}, headers);
  ...
  async bookSeva(sevaId) {
    ...
    try {
      ...
      const response = await axios.post('/v1/sevas/bookings', payload, headers);
  ...
  async getMyBookings() {
    try {
      ...
      const response = await axios.get('/v1/sevas/my-bookings', headers);
  ...
  async getEntityBookings(entityId) {
    try {
      ...
      const url = resolvedEntityId ? 
        `/v1/sevas/entity-bookings?entity_id=${resolvedEntityId}` : 
        '/v1/sevas/entity-bookings';
  ...
  async getBookingById(bookingId) {
    try {
      ...
      const response = await axios.get(`/v1/sevas/bookings/${bookingId}`, headers);
  ...
  async updateBookingStatus(bookingId, status) {
    try {
      ...
      const response = await axios.patch(`/v1/sevas/bookings/${bookingId}/status`, 
        { status }, 
        headers
      );
